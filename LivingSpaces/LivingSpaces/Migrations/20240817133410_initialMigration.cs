        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfListings = table.Column<int>(type: "int", nullable: false),
                    SupportVr = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ListingActiveDays = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Texts_AspNetUsers_RecipientId",
                        column: x => x.RecipientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Texts_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VRUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Properties", x => x.PropertyListingID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ListingPhoto_Properties_PropertyListingID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListingPhoto_PropertyListingID",
                table: "ListingPhoto",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Texts_RecipientId",
                table: "Texts",
                column: "RecipientId");

            migrationBuilder.CreateIndex(
                name: "IX_Texts_SenderId",
                table: "Texts",
                column: "SenderId");
